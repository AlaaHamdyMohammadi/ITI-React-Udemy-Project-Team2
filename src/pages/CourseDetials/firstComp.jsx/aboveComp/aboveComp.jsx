...
export default function AboveList({ course }) {
  ...
  return (
    <>
  <div className="border  customwidthh flex flex-col border-white shadow shadow-gray-400">
  {/* video */}
  <div>
<video width="640" height="360" controls>
  ...
  <div className="container   pt-4 flex flex-col">
    ...
    <div>
      <div className="flex flex-row gap-3">
        <span className="text-4xl text-black font-semibold">E${course.price}</span>
    ...
    {/* static */}
    <div className="p-2 text-center  text-black text-sm">
      30-Day Money-Back Guarantee
    </div>
    {/* course include */}
    <div>
      <div className="text-lg text-black font-bold">This course includes:</div>
      <div>
  ...
  <div className="container flex flex-col">
    <div className="text-lg text-black font-bold">Training 5 or more people?</div>
