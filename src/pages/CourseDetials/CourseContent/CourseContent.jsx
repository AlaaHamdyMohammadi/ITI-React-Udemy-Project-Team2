  ...
  return (
    <>
      <div className="">
		...
		<div  key={item.header} className="  bg-gray-100 border border-gray-400 p-3">
			<details className="group">
				<summary className="  grid grid-cols-12  justify-between items-center font-bold cursor-pointer list-none">
