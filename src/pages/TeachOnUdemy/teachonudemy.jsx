...
export default function TeachOnUdemy(){
    ...
    <div className="d-flex flex-md-row flex-column">
        <div className="row position-relative head flex-grow-1">
            <div>
                <img src="./public/images/teach on udemy/billboard-desktop-v4.jpg" className="vw-100"/>
            </div>
    ...
    <div className="d-flex flex-column text-center p-5">
        ...
        <div className="row">
            <div className="col-lg-3 m-12 m-auto">
                <img className="m-auto" src="./public/images/teach on udemy/value-prop-teach-v3.jpg" />
                <h3>Teach your way</h3>
                <p>Publish the course you want, in the way you want, and always have control of your own content.</p>
            </div>
            <div className="col-lg-3 m-12 m-auto">
                <img className="m-auto" src="./public/images/teach on udemy/value-prop-inspire-v3.jpg" />
                <h3>Inspire learners</h3>
                <p>Teach what you know and help learners explore their interests, gain new skills, and advance their
                    careers.</p>
            </div>
            <div className="col-lg-3 m-12 m-auto">
                <img className="m-auto" src="./public/images/teach on udemy/value-prop-get-rewarded-v3.jpg" />
                <h3>Get rewarded</h3>
        ...
        <div className="row  text-center">
            <h1>How to begin</h1>
                    ...
                    <Tabs defaultActiveKey="profile" id="uncontrolled-tab-example"
                        className="d-flex m-2 mb-5" fill>
                        <Tab eventKey="home" title="Plan your curriculum">
                            <div className="container-fluid" id="1">
                                <div className="row">
                                    <div className="col-lg-4 col-12 align-self-center text-start fs-5 ms-auto">
                                    ...
                                    <div className="col-lg-3 me-auto">
                                        <img src="./public/images/teach on udemy/1.jpg" className="col-10" />
                                    </div>
                                </div>
                            </div>
                        </Tab>
                        ...
                        <div className="container-fluid" id="2">
                                <div className="row">
                                    ...
                                    <div className="col-lg-3 me-auto">
                                        <img src="./public/images/teach on udemy/2.jpg" className="col-10"/>
                                    </div>
                                </div>
                            </div>
                        </Tab>
                        ...
                        <Tab eventKey="contact" title="Launch your course">
                            <div className="container-fluid" id="2">
                                <div className="row">
                                    ...
                                    <div className="col-lg-3 me-auto">
                                        <img src="./public/images/teach on udemy/3.jpg" className="col-10" />
                                    </div>
                                </div>
                            </div>
                        </Tab>
