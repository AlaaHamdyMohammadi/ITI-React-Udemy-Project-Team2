...
export default function Instractor(){
    ...
    <div className="sidemenue position-fixed text-white p-2 overflow-hidden text-center" onMouseLeave={()=>{setWide(false)}} onMouseOver={()=>{setWide(true)}}>
       {(isWide)?<img src="./public/images/instractor/udemy.png" className="col-10 fullUdemy"/>:<img src="./public/images/instractor/xShJF4Km_400x400.png" className="col-10 Ulogo" />} 
        ...
        <div className="d-flex mt-3 btn btn-dark"><BsQuestionCircle className="fa-regular fa-circle-question fs-3" />{(isWide)?<h5 classNameName="myMenuItem">Resources</h5>:""}</div>
    </div>
    ...
    <div className="main container mt-5">
        ...
        <div className="row justify-content-center shadow p-5">
            ...
            <div className="col-7">
                ...
                <h6 className="mt-5">Whether you've been teaching for years or are teaching for the first time, you can make an engaging course. We've compiled resources and best practices to help you get to the next level, no matter where you're starting.</h6>
